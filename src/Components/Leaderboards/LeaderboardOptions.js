...
export function LeaderboardOptions(props){
    ...
    return (
        <div className={`${expandOptions ? "max-h-screen" : "max-h-8"} lg:max-h-screen max-w-full h-96 lg:h-40 mt-5 pt-1 mx-auto bg-white rounded-md shadow-md transition-maxHeight duration-300 flex flex-col`}>
            <div className="text-center mb-3 font-light uppercase flex justify-between lg:hidden">
