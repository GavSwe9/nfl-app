    ...
    if (props.loading) {
        return (
            <>
                ...
                <div className="w-full sm:min-h-screen lg:min-h-0 mx-auto bg-white rounded-md border border-gray-300 flex-1 overflow-auto text-xs lg:text-sm font-mono font-light text-center">
                    <div className="mt-5">
